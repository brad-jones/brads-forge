 ...
 */
export function digestFromChecksumTXT(
 ...
 * @returns A new Digest object.
 */
export async function digestFromChecksumFile(
  digestAlg: DigestAlgorithmName,
  fileName: string,
  checkSumPath: string,
) {
 ...
 * @returns A new Digest object.
 */
export async function digestFromChecksumURL(
  digestAlg: DigestAlgorithmName,
  fileName: string,
  checksumUrl: string,
  headers?: Record<string, string>,
) {
  const r = await ky.get(checksumUrl, { redirect: "follow", headers });
