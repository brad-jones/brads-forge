...
export interface Build {
     ...
     */
    includeRecipe?: boolean & tags.Default<true>;
    /**
     ...
     */
    skipCompilePyc?: PathNoBackslash | PathNoBackslash[];
    /**
     * A list of rpaths (Linux only).
     */
    rpaths?: (string & tags.Default<"lib/">) | string[];
    /**
     * Files to be included even if they are present in the PREFIX before building.
     */
    alwaysIncludeFiles?: string | string[];
    osxIsApp?: boolean & tags.Default<false>;
    disablePip?: boolean & tags.Default<false>;
    preserveEggDir?: boolean & tags.Default<false>;
    forceUseKeys?: string | string[];
    forceIgnoreKeys?: string | string[];
    mergeBuildHost?: boolean & tags.Default<false>;
    missingDsoWhitelist?: string | string[];
    runpathWhitelist?: string | string[];
    errorOverdepending?: boolean & tags.Default<false>;
    errorOverlinking?: boolean & tags.Default<false>;
}
